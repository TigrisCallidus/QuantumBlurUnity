...
public class QuantumBlurUsage : MonoBehaviour {
    ...
    public static Texture2D CalculateMyOwnEffect(Texture2D inputTexture, float parameter1 = 0, float parameter2 = 0, float parameter3 = 0) {
        ...
        /*
        ApplyPartialQToFraction(red, 0.3f, 4, 1);
        ApplyPartialQToFraction(green, 0.3f, 2, 0);
        ApplyPartialQToFraction(blue, 0.3f, 2, 1);
        ...
        ApplyHadamar(red,5);
        ApplyHadamar(green,5);
        ApplyHadamar(blue,5);
        // */

        /*

        ApplyControlledNotToFraction(red,5);
        ApplyControlledNotToFraction(green,5);
        ApplyControlledNotToFraction(blue,5);

        / */


        /*
        ApplyControledQtoFraction(red, MathHelper.PiHalfFloat);
        ApplyControledQtoFraction(green, MathHelper.PiHalfFloat);
        ApplyControledQtoFraction(blue, MathHelper.PiHalfFloat);

        // */

        /*
        ApplyControledQtoFraction(red, MathHelper.PiHalfFloat, 2, 1, 0);
        ApplyControledQtoFraction(green, MathHelper.PiHalfFloat);
        ApplyControledQtoFraction(blue, MathHelper.PiHalfFloat);
    ...
    public void SetImage() {
        if (TargetImage != null) {
            TargetImage.texture = OutputTexture;
        }
    }
